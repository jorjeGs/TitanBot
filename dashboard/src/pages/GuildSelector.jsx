...
import { Search, Server, Plus, Settings, ExternalLink, Crown, Shield } from 'lucide-react';
                ...
                <div className="flex items-center gap-3.5 mb-4">
                  {guild.icon ? (
                    <img
                      src={guild.icon}
                      alt={guild.name}
                      className="w-12 h-12 rounded-2xl object-cover ring-2 ring-slate-700/60 shadow-md group-hover:ring-discord-blurple/50 transition-all shrink-0"
                    />
                  ) : (
                    <div className="w-12 h-12 rounded-2xl bg-slate-700/60 flex items-center justify-center font-bold text-lg text-slate-300 ring-2 ring-slate-700/60 shadow-md shrink-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-1.5 flex-wrap">
                      ...
                      {guild.owner ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-purple-500/10 text-purple-300 border border-purple-500/20">
