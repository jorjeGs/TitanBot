...
const CRIME_TYPES = [
    { key: "pickpocketing", name: "Pickpocketing", min: 100, max: 500, risk: 0.3 },
    { key: "burglary", name: "Burglary", min: 300, max: 1000, risk: 0.4 },
    { key: "bank-heist", name: "Bank Heist", min: 1000, max: 5000, risk: 0.6 },
    { key: "art-theft", name: "Art Theft", min: 2000, max: 10000, risk: 0.7 },
    { key: "cybercrime", name: "Cybercrime", min: 5000, max: 20000, risk: 0.8 },
];
        ...
        await InteractionHelper.safeDefer(interaction);
            ...
            if (isJailed) {
                ...
                throw createError(
                    ...
                    t('economy:crime_jailed', { time: timeLeft }, interaction),
            ...
            if (now < lastCrime + CRIME_COOLDOWN) {
                ...
                throw createError(
                    ...
                    ErrorTypes.RATE_LIMIT,
                    t('economy:crime_cooldown', { time: timeLeft }, interaction),
            ...
            const crime = CRIME_TYPES.find(
                c => c.key === crimeType || c.name.toLowerCase().replace(/\s+/g, '-') === crimeType
            );
            ...
            if (!crime) {
                throw createError(
                    ...
                    t('economy:crime_err_type', interaction),
                    { crimeType }
                );
            }
            ...
            const localizedCrimeName = t(`economy:crime_types.${crime.key}`, interaction);
            ...
            if (isSuccess) {
                ...
                const embed = successEmbed(
                    t('economy:crime_title_success', interaction),
                    t('economy:crime_success', { crime: localizedCrimeName, amount: amountEarned.toLocaleString() }, interaction)
                );
                ...
                const embed = warningEmbed(
                    t('economy:crime_title_fail', interaction),
                    t('economy:crime_fail', { crime: localizedCrimeName, fine: fine.toLocaleString() }, interaction)
                );
